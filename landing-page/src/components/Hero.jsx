    ...
    <div className="min-h-screen relative overflow-hidden" style={{backgroundColor: '#fefff4'}}>
      ...
      <div className="relative px-6" style={{backgroundColor: '#fefff4'}}>
        ...
        <div className="hidden md:block absolute left-6 top-8 z-10 max-w-xs">
          <p className="text-sm text-gray-600 leading-relaxed mb-8 translate-x-8" ref={paraRef}>
            {"Transform your skincare routine with products that restore, protect, and enhance your natural glow every day.".split(" ").map((word, i) => (
        ...
        <div className="text-center pt-4 pb-8">
          ...
          <div className="block md:hidden mt-6">
            <p className="text-sm text-gray-600 leading-relaxed mb-4" ref={paraRef}>
              {"Transform your skincare routine with products that restore, protect, and enhance your natural glow every day.".split(" ").map((word, i) => (
                <span key={i} className="word" style={{ transition: 'opacity 0.4s' }}>{word} </span>
              ))}
            </p>
        ...
        </div> {/* End of Product Image - Top Right */}
        ...
        <div className="relative flex justify-center items-center mt-4 mb-12 z-10">
          <div className="relative w-100 h-96 bg-gradient-to-br from-amber-100 via-green-100 to-green-200 rounded-3xl shadow-2xl overflow-hidden">
            ...
            />
            {/* Floating tooltip */}
            <div className="absolute bottom-6 left-4 rounded-full px-4 py-3 text-xs text-gray-700 shadow-lg max-w-xs z-30" style={{ backgroundColor: '#eff5e1' }}>
        ...
        <div className="mt-16 max-w-4xl mx-auto text-center">
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            natural ingredients with <span className="text-gray-400">advanced science, our collection ensures every 
