...
#fefff4] p-4 sm:p-8"
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Product Cards */}
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 transition-transform duration-500`}
        >
          {visibleProducts.map((product) => (
            ...
            >
              ...
              <div
                className={`relative ${product.bgColor} rounded-3xl overflow-hidden h-72 sm:h-96 mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-105`}
              >
                {/* Full Product Image */}
                <img
                  src={product.image}
